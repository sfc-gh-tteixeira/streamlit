...
st._arrow_bar_chart(df, x="a", y=["b", "c"], color=["orange", "green"])
st._arrow_bar_chart(df, x="a", y="b", color="orange")
st._arrow_bar_chart(df2, x="a", y="b", color="e")
st._arrow_bar_chart(df2, x="a", y="b", color="f")
